		...
		<div class="card">
			...
			<div class="card-body">
		    	<form method="POST" class="appForm" action="{{ route('todo.store') }}">
		    		@csrf
                    <input type="hidden" id="timezone" class="form-control form-control-sm" name="timezone"  />
		    		<div class="row">
		    			...
		    			<div class="col-md-6 form-group">
		    				...
		    				<input type="datetime-local" class="form-control form-control-sm" name="due_date" value="{{ date('Y-m-d') }}" />
		    			</div>
		    			<div class="col-md-6 form-group">
		    				<label>Status</label>
